    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary/90 via-primary to-primary/80">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/3 left-1/3 h-64 w-64 rounded-full bg-white/20 blur-3xl animate-pulse" />
          <div className="absolute bottom-1/3 right-1/3 h-96 w-96 rounded-full bg-white/10 blur-3xl animate-pulse [animation-delay:1s]" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-xl text-white/80 mb-2">客户门户</p>
          <p className="text-white/60 max-w-md leading-relaxed">
            一站式回拨业务管理。发起回拨、查询话单、实时监控通话状态。
          </p>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-background px-6">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight">客户登录</h2>
            <p className="text-muted-foreground mt-1">登录您的业务账户</p>
          </div>
